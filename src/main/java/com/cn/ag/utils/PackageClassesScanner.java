...
public class PackageClassesScanner {
     ...
     */
    public PackageClassesScanner(String[] packagesToScan, Class<? extends Annotation>... annotationFilter){
        if (packagesToScan != null) {
            this.packagesList.addAll(Arrays.asList(packagesToScan));
        }
